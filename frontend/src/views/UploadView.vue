...
import { uploadItem, getMyPublishedItems, getMyDrafts, getItems, getItemById, updateDraft, publishDraft, type Item } from '@/api/items'
...
const type = ref<'extension' | 'theme' | 'app-extension' | 'app-theme'>('extension')
